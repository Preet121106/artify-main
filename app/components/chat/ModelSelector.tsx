...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-artify-elements-borderColor bg-artify-elements-prompt-background text-artify-elements-textPrimary">
  ...
  return (
    <div className="flex gap-2 flex-col sm:flex-row">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-artify-elements-borderColor bg-artify-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
            <div className="px-2 pb-2">
              <div className="relative">
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-artify-elements-textTertiary" />
                </div>
              </div>
            </div>
            ...
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-2 text-sm text-artify-elements-textTertiary">No providers found</div>
              ) : (
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-artify-elements-borderColor bg-artify-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
            <div className="px-2 pb-2">
