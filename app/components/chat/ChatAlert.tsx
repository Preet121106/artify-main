  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`rounded-lg border border-artify-elements-borderColor bg-artify-elements-background-depth-2 p-4 mb-2`}
      >
        <div className="flex items-start">
          ...
          >
            <div className={`i-ph:warning-duotone text-xl text-artify-elements-button-danger-text`}></div>
          </motion.div>
          {/* Content */}
          <div className="ml-3 flex-1">
            <motion.h3
              ...
              className={`text-sm font-medium text-artify-elements-textPrimary`}
            >
              {title}
            </motion.h3>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 0.2 }}
              className={`mt-2 text-sm text-artify-elements-textSecondary`}
            >
              <p>{message}</p>
              {description && (
                <div className="text-xs text-artify-elements-textSecondary p-2 bg-artify-elements-background-depth-3 rounded mt-4 mb-4">
                  Error: {description}
                </div>
              )}
            </motion.div>
