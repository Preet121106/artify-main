  ...
  return (
    ...
    >
      ...
      {props.selectedElement && (
        <div className="flex mx-1.5 gap-2 items-center justify-between rounded-lg rounded-b-none border border-b-none border-artify-elements-borderColor text-artify-elements-textPrimary py-1 px-2.5 font-medium text-xs">
          ...
          <div className="flex gap-1 items-center">
            ...
            >
              {props.enhancingPrompt ? (
                <div className="i-svg-spinners:90-ring-with-bg text-artify-elements-loader-progress text-xl animate-spin"></div>
              ) : (
                <div className="i-artify:stars text-xl"></div>
              )}
            </IconButton>
