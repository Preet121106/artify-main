  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="max-w-chat rounded-lg border-l-2 border-l-[#098F5F] border border-artify-elements-borderColor bg-artify-elements-background-depth-2"
      >
        {/* Header */}
        ...
        <div className="px-4">
          {!isConnected ? (
            <div className="p-3 rounded-md bg-artify-elements-background-depth-3">
              <span className="text-sm text-artify-elements-textPrimary">
            ...
            <>
              <div
                className="flex items-center p-2 rounded-md bg-artify-elements-background-depth-3 cursor-pointer"
              ...
              {!isCollapsed && content && (
                <div className="mt-2 p-3 bg-artify-elements-background-depth-4 rounded-md overflow-auto max-h-60 font-mono text-xs text-artify-elements-textSecondary">
        ...
        {/* Message and Actions */}
        <div className="p-4">
          <p className="text-sm text-artify-elements-textSecondary mb-4">{message}</p>
