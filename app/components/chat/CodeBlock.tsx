      ...
      <div className={classNames("relative group text-left", className)}>
        ...
        >
          {!disableCopy && (
            <button
              className={classNames(
                "flex items-center bg-accent-500 p-[6px] justify-center before:bg-gray before:rounded-l-md before:text-gray-500 before:border-r before:border-gray-300 rounded-md transition-theme",
                {
