...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-artify-elements-textPrimary hover:text-artify-elements-textPrimary',
...
export const DropdownSeparator = () => <DropdownMenu.Separator className="h-px bg-artify-elements-borderColor my-1" />;
