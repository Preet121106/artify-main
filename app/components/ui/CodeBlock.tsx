...
export function CodeBlock({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-2 bg-artify-elements-background-depth-3 dark:bg-artify-elements-background-depth-4 border-b border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
        <div className="flex items-center gap-2">
          {filename && (
            <>
              <FileIcon filename={filename} size="sm" />
              <span className="text-xs font-medium text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                {filename}
              </span>
            </>
          )}
          {language && !filename && (
            <span className="text-xs font-medium text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark uppercase">
              {language}
            </span>
          )}
        </div>
        ...
        <table className="min-w-full border-collapse">
          <tbody>
            {lines.map((line, index) => (
              ...
              >
                {showLineNumbers && (
                  <td className="py-1 pl-4 pr-2 text-right select-none text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark border-r border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
