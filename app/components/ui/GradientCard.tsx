...
const GRADIENT_COLORS = [
  ...
  "from-red-500/10 to-blue-500/5",
  "from-blue-500/10 to-green-500/5",
];
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect
          ? "border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark hover:border-green-500/40"
          : "",
