  ...
  return (
    <div
      className={classNames(
        ...
        "text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark",
        "bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 rounded-lg",
        styles.container,
        className,
      )}
    >
      ...
      <div
        className={classNames(
          "rounded-full bg-artify-elements-background-depth-3 dark:bg-artify-elements-background-depth-4 flex items-center justify-center",
      ...
      {description && (
        <p
          className={classNames(
            "text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark text-center max-w-xs",
            styles.description,
          )}
        >
          {description}
