          ...
          <div className="flex flex-col">
            ...
            {showCloseButton && (
              <RadixDialog.Close asChild onClick={onClose}>
                <IconButton
                  icon="i-ph:x"
                  className="absolute top-3 right-3 text-artify-elements-textTertiary hover:text-artify-elements-textSecondary"
                />
              </RadixDialog.Close>
            )}
          </div>
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          {item.description && <p className="text-xs text-artify-elements-textSecondary">{item.description}</p>}
        </div>
      </div>
    );
  };
        ...
        <div className="p-6 bg-gray dark:bg-gray-950 relative z-10">
          ...
          <div className="py-4">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm font-medium text-artify-elements-textSecondary">
            ...
            <div
              className="pr-2 border rounded-md border-artify-elements-borderColor bg-artify-elements-bg-depth-2"
              style={{
                maxHeight,
              }}
            >
              {items.length > 0 ? (
                <FixedSizeList
                  ...
                  itemSize={60}
                  className="scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-artify-elements-bg-depth-3"
                >
                  {ItemRenderer}
                </FixedSizeList>
              ) : (
                <div className="text-center py-4 text-sm text-artify-elements-textTertiary">No items to display</div>
              )}
            </div>
          </div>
          ...
          <div className="flex justify-between mt-6">
            <Button
              variant="outline"
              onClick={onClose}
              className="border-artify-elements-borderColor text-artify-elements-textPrimary hover:bg-artify-elements-item-backgroundActive"
            >
              Cancel
            </Button>
            <Button
