...
export function SearchResultItem({
  ...
  description,
  icon,
  iconBackground = 'bg-artify-elements-background-depth-1/80 dark:bg-artify-elements-background-depth-4/80',
  ...
  return (
    <motion.div
      className={classNames(
        'p-5 rounded-xl border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark hover:border-green-500/40 transition-all duration-300 shadow-sm hover:shadow-md bg-artify-elements-background-depth-1/50 dark:bg-artify-elements-background-depth-3/50',
    ...
    >
      ...
      {metadata && metadata.length > 0 && (
        <div className="flex flex-wrap items-center gap-3 text-xs text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark">
          {metadata.map((item, index) => (
            <div key={index} className="flex items-center gap-1">
              ...
              <span>
                ...
                {item.value !== undefined && (
                  <span className="text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                    {item.value}
                  </span>
                )}
              </span>
