    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-gray dark:bg-gray-950 border-r border-artify-elements-borderColor',
          'shadow-sm text-sm',
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-500/20 rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-green-600 dark:bg-green-500 text-white border border-green-700 dark:border-green-600'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800"
                type="search"
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-2 first:mt-0 space-y-1">
                  <div className="text-xs font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-1 bg-gray dark:bg-gray-950 px-4 py-1">
                    {category}
                  </div>
              ...
              <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-gray dark:bg-gray-950">
