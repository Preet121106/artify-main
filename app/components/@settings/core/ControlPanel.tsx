...
const BetaLabel = () => (
  <div className="absolute top-2 right-2 px-1.5 py-0.5 rounded-full bg-green-500/10 dark:bg-green-500/20">
    <span className="text-[10px] font-medium text-green-600 dark:text-green-400"></span>
  </div>
);
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        ...
        >
          <motion.div
            className="absolute inset-0 rounded-full bg-gray"
            initial={false}
            animate={{
              scale: checked ? 1 : 0.8,
            }}
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2 min-w-[140px] border-r border-gray-200 dark:border-gray-800 pr-6">
                      <AnimatedSwitch
                        ...
                        label={developerMode ? 'Developer' : 'User'}
                      />
                    </div>
