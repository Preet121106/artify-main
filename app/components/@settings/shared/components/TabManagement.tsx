...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 text-[10px] rounded-full bg-green-500/10 text-green-500 font-medium">BETA</span>
);
      ...
      >
        ...
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-artify-elements-textPrimary">Tab Management</h4>
              <p className="text-sm text-artify-elements-textSecondary">Configure visible tabs and their order</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              <div className="i-ph:star-fill w-4 h-4 text-green-500" />
              <span className="text-sm font-medium text-artify-elements-textPrimary">Default Tabs</span>
            </div>
          )}
            ...
            .map((tab, index) => (
              ...
              >
                ...
                <div className="absolute top-1 right-1.5 flex gap-1">
                  <span className="px-1.5 py-0.25 text-xs rounded-full bg-green-500/10 text-green-500 font-medium mr-2">
                    Default
                  </span>
                </div>
                ...
                <div className="flex items-start gap-4 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="text-sm font-medium text-artify-elements-textPrimary group-hover:text-green-500 transition-colors">
                            {TAB_LABELS[tab.id]}
                          </h4>
          ...
          {filteredTabs.some((tab) => OPTIONAL_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-8 mb-2">
              ...
              <span className="text-sm font-medium text-artify-elements-textPrimary">Optional Tabs</span>
            </div>
          )}
