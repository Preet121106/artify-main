  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-full">
        <div className="animate-spin i-ph:circle-notch w-8 h-8 text-green-500" />
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 gap-4">
        {serviceStatuses.map((service) => (
          <div
            ...
            className="p-4 bg-gray dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
          >
