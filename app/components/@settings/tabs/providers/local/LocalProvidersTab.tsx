...
export default function LocalProvidersTab() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header section */}
        <div className="flex items-center justify-between gap-4 border-b border-artify-elements-borderColor pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-semibold text-artify-elements-textPrimary">Local AI Models</h2>
              </div>
              <p className="text-sm text-artify-elements-textSecondary">Configure and manage your local AI providers</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-sm text-artify-elements-textSecondary">Enable All</span>
            <Switch
                ...
                {provider.settings.enabled && (
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <label className="text-sm text-artify-elements-textSecondary">API Endpoint</label>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="text-sm font-medium text-artify-elements-textPrimary">Installed Models</h4>
                    </div>
                    {isLoadingModels ? (
                      <div className="flex items-center gap-2">
                        <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
                        <span className="text-sm text-artify-elements-textSecondary">Loading models...</span>
                      </div>
                    ) : (
                    ...
                    {isLoadingModels ? (
                      <div className="space-y-3">
                        {Array.from({ length: 3 }).map((_, i) => (
                          <div
                            key={i}
                            className="h-20 w-full bg-artify-elements-background-depth-3 rounded-lg animate-pulse"
                          />
                        ))}
                      </div>
                    ) : ollamaModels.length === 0 ? (
                      <div className="text-center py-8 text-artify-elements-textSecondary">
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                                <h5 className="text-sm font-medium text-artify-elements-textPrimary">{model.name}</h5>
                          ...
                          {model.progress && (
                            <div className="mt-3">
                              <Progress
                                ...
                                className="h-1"
                              />
                              <div className="flex justify-between mt-1 text-xs text-artify-elements-textSecondary">
        ...
        <div className="border-t border-artify-elements-borderColor pt-6 mt-8">
