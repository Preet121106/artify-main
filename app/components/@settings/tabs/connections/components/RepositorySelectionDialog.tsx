    ...
    <RepositoryDialogContext.Provider value={{ setShowAuthDialog }}>
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[650px] max-h-[85vh] overflow-hidden bg-gray dark:bg-artify-elements-background-depth-1 rounded-xl shadow-xl z-[51] border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
            {/* Header */}
            <div className="p-5 border-b border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-green-500/20 to-blue-500/10 flex items-center justify-center text-green-500 shadow-sm">
                  <span className="i-ph:github-logo w-5 h-5" />
                </div>
                <div>
                  <Dialog.Title className="text-lg font-semibold text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark">
                    Import GitHub Repository
                  </Dialog.Title>
                  <p className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
              ...
              <Dialog.Close
                ...
                className={classNames(
                  ...
                  'text-artify-elements-textTertiary hover:text-artify-elements-textPrimary',
                  'dark:text-artify-elements-textTertiary-dark dark:hover:text-artify-elements-textPrimary-dark',
                  'hover:bg-artify-elements-background-depth-2 dark:hover:bg-artify-elements-background-depth-3',
                  'focus:outline-none focus:ring-2 focus:ring-artify-elements-borderColor dark:focus:ring-artify-elements-borderColor-dark',
                )}
              >
            ...
            {/* Auth Info Banner */}
            <div className="p-4 border-b border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark flex items-center justify-between bg-gradient-to-r from-artify-elements-background-depth-2 to-artify-elements-background-depth-1 dark:from-artify-elements-background-depth-3 dark:to-artify-elements-background-depth-2">
              <div className="flex items-center gap-2">
                <span className="i-ph:info text-blue-500" />
                <span className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                  Need to access private repositories?
                </span>
              </div>
              <motion.button
                onClick={() => setShowAuthDialog(true)}
                className="px-3 py-1.5 rounded-lg bg-green-500 hover:bg-green-600 text-white text-sm transition-colors flex items-center gap-1.5 shadow-sm"
            ...
            <div className="p-5">
              {/* Tabs */}
              <div className="mb-6">
                <div className="bg-[#f0f0f0] dark:bg-[#1e1e1e] rounded-lg overflow-hidden border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                  <div className="flex">
                    <button
                      ...
                      className={classNames(
                        ...
                        activeTab === 'my-repos'
                          ? 'bg-[#e6e6e6] dark:bg-[#2a2a2a] text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark'
                          : 'bg-[#f0f0f0] dark:bg-[#1e1e1e] text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark hover:bg-[#e6e6e6] dark:hover:bg-[#2a2a2a]/50',
                      )}
                    >
                      My Repos
                    </button>
              ...
              {activeTab === 'url' ? (
                <div className="space-y-5">
                  <div className="bg-gradient-to-br from-artify-elements-background-depth-1 to-artify-elements-background-depth-1 dark:from-artify-elements-background-depth-2-dark dark:to-artify-elements-background-depth-2-dark p-5 rounded-xl border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                    <h3 className="text-base font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark mb-3 flex items-center gap-2">
                      <span className="i-ph:link-simple w-4 h-4 text-green-500" />
                      Repository URL
                    </h3>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="w-full pl-10 py-3 border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      />
                    </div>

                    <div className="mt-3 text-xs text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark bg-gray/50 dark:bg-artify-elements-background-depth-4/50 p-3 rounded-lg border border-artify-elements-borderColor/30 dark:border-artify-elements-borderColor-dark/30 backdrop-blur-sm">
                      <p className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <br />
                          <span className="text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark">
                  ...
                  <div className="flex items-center gap-3 text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                    <div className="h-px flex-grow bg-artify-elements-borderColor dark:bg-artify-elements-borderColor-dark"></div>
                ...
                <>
                  {activeTab === 'search' && (
                    <div className="space-y-5 mb-5">
                      <div className="bg-gradient-to-br from-blue-500/5 to-cyan-500/5 p-5 rounded-xl border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                        <h3 className="text-base font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark mb-3 flex items-center gap-2">
                        ...
                        <div className="flex gap-2">
                          <div className="flex-1">
                            <SearchInput
                              ...
                              className="py-3 bg-gray dark:bg-artify-elements-background-depth-4 border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
                              loading={isLoading}
                            />
                          </div>
                          <motion.button
                            onClick={() => setFilters({})}
                            className="px-3 py-2 rounded-lg bg-gray dark:bg-artify-elements-background-depth-4 text-artify-elements-textSecondary hover:text-artify-elements-textPrimary border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark shadow-sm"
                        ...
                        <div className="mt-3">
                          <div className="text-xs text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark mb-2">
                            Filters
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <div className="relative col-span-3 md:col-span-1">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark">
                              ...
                              <input
                                ...
                                className="w-full pl-8 px-3 py-2 text-sm rounded-lg bg-gray dark:bg-artify-elements-background-depth-4 border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
                              />
                            </div>
                            <div className="relative">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark">
                  ...
                  <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {selectedRepository ? (
                      <div className="space-y-5 bg-gradient-to-br from-green-500/5 to-blue-500/5 p-5 rounded-xl border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <motion.button
                              onClick={() => setSelectedRepository(null)}
                              className="p-2 rounded-lg hover:bg-gray dark:hover:bg-artify-elements-background-depth-4 text-artify-elements-textSecondary hover:text-artify-elements-textPrimary shadow-sm"
                            ...
                            <div>
                              <h3 className="font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark text-lg">
                        ...
                        {selectedRepository.description && (
                          <div className="bg-gray/50 dark:bg-artify-elements-background-depth-4/50 p-3 rounded-lg border border-artify-elements-borderColor/30 dark:border-artify-elements-borderColor-dark/30 backdrop-blur-sm">
                            <p className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                              {selectedRepository.description}
                            </p>
                          </div>
                        ...
                        <div className="pt-3 border-t border-artify-elements-borderColor/30 dark:border-artify-elements-borderColor-dark/30">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="i-ph:git-branch w-4 h-4 text-green-500" />
                            <label className="text-sm font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark">
                              Select Branch
                            </label>
                          </div>
                          <select
                            ...
                            className="w-full px-3 py-3 rounded-lg bg-gray dark:bg-artify-elements-background-depth-4 border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-green-500 shadow-sm"
                          >
                            {branches.map((branch) => (
                              <option
                                key={branch.name}
                                value={branch.name}
                                className="bg-gray dark:bg-artify-elements-background-depth-4 text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark"
                              >
                        ...
                        <div className="flex items-center gap-3 text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                          <div className="h-px flex-grow bg-artify-elements-borderColor/30 dark:bg-artify-elements-borderColor-dark/30"></div>
                          <span>Ready to import?</span>
                          <div className="h-px flex-grow bg-artify-elements-borderColor/30 dark:bg-artify-elements-borderColor-dark/30"></div>
                        </div>
                        ...
                        <motion.button
                          onClick={handleImport}
                          className="w-full h-12 px-4 py-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white transition-all duration-200 flex items-center gap-2 justify-center shadow-md"
