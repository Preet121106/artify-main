      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-gray dark:bg-artify-elements-background-depth-1 rounded-lg border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark shadow-xl"
                aria-describedby="success-dialog-description"
              >
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-green-500 bg-opacity-10 flex items-center justify-center text-green-500">
                        <div className="i-ph:check-circle w-5 h-5" />
                      </div>
                      <div>
                        <h3 className="text-lg font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark">
                          Successfully pushed to GitHub
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark"
                        >
                  ...
                  <div className="bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 rounded-lg p-4 text-left border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                    <p className="text-sm font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:github-logo w-4 h-4 text-green-500" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-4 px-3 py-2 rounded border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                  ...
                  <div className="bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 rounded-lg p-4 border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                    <p className="text-sm font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:files w-4 h-4 text-green-500" />
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark border-b border-artify-elements-borderColor/30 dark:border-artify-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-artify-elements-background-depth-3 dark:bg-artify-elements-background-depth-4 text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark ml-2">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="px-4 py-2 rounded-lg bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark hover:bg-artify-elements-background-depth-3 dark:hover:bg-artify-elements-background-depth-4 text-sm border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-gray dark:bg-artify-elements-background-depth-1 rounded-lg p-6 border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark shadow-xl"
              ...
              >
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-artify-elements-background-depth-3 flex items-center justify-center text-green-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-artify-elements-background-depth-3 flex items-center justify-center text-green-500"
                  >
                    <div className="i-ph:github-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark">
                      Push to GitHub
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 rounded-lg border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                  <div className="relative">
                    <img src={user.avatar_url} alt={user.login} className="w-10 h-10 rounded-full" />
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-green-500 flex items-center justify-center text-white">
                      <div className="i-ph:github-logo w-3 h-3" />
                    </div>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark placeholder-artify-elements-textTertiary dark:placeholder-artify-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-green-500"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== "" ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 hover:bg-artify-elements-background-depth-3 dark:hover:bg-artify-elements-background-depth-4 transition-colors group border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark hover:border-green-500/30"
                              whileHover={{ scale: 1.01 }}
                              whileTap={{ scale: 0.99 }}
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <div className="i-ph:git-branch w-4 h-4 text-green-500" />
                                  <span className="text-sm font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark group-hover:text-green-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-artify-elements-textSecondary dark:text-artify-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-3 rounded-lg border border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-artify-elements-borderColor dark:border-artify-elements-borderColor-dark text-green-500 focus:ring-green-500 dark:bg-artify-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-artify-elements-textPrimary dark:text-artify-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-artify-elements-textTertiary dark:text-artify-elements-textTertiary-dark mt-2 ml-6">
