...
const LoadingFallback = () => (
  <div className="p-4 bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-1 rounded-lg border border-artify-elements-borderColor dark:border-artify-elements-borderColor">
    <div className="flex items-center justify-center gap-2 text-artify-elements-textSecondary dark:text-artify-elements-textSecondary">
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          <div className="i-ph:plugs-connected w-5 h-5 text-artify-elements-item-contentAccent dark:text-artify-elements-item-contentAccent" />
          <h2 className="text-lg font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary">
            Connection Settings
          </h2>
        </div>
        <Button
      ...
      <motion.div
        className="bg-artify-elements-background dark:bg-artify-elements-background rounded-lg border border-artify-elements-borderColor dark:border-artify-elements-borderColor"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="p-6">
          ...
          >
            <div className="flex items-center gap-2">
              <div className="i-ph:info w-5 h-5 text-artify-elements-item-contentAccent dark:text-artify-elements-item-contentAccent" />
          ...
          {isEnvVarsExpanded && (
            <div className="mt-4">
              ...
              <div className="bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-2 p-3 rounded-md text-xs font-mono overflow-x-auto">
                <div className="text-artify-elements-textSecondary dark:text-artify-elements-textSecondary">
                  # GitHub Authentication
                </div>
                <div className="text-artify-elements-textPrimary dark:text-artify-elements-textPrimary">
                ...
                <div className="text-artify-elements-textSecondary dark:text-artify-elements-textSecondary mt-2">
              ...
              <div className="mt-3 text-xs text-artify-elements-textSecondary dark:text-artify-elements-textSecondary space-y-1">
                <p>
      ...
      <div className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-2 p-4 rounded-lg">
        <p className="flex items-center gap-1 mb-2">
          <span className="i-ph:lightbulb w-4 h-4 text-artify-elements-icon-success dark:text-artify-elements-icon-success" />
