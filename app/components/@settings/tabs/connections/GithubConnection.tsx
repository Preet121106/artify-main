...
export default function GitHubConnection() {
  ...
  return (
    <motion.div
      className="bg-artify-elements-background dark:bg-artify-elements-background border border-artify-elements-borderColor dark:border-artify-elements-borderColor rounded-lg"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <GithubLogo />
            <h3 className="text-base font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary">
              GitHub Connection
            </h3>
          </div>
        </div>
        ...
        {!connection.user && (
          <div className="text-xs text-artify-elements-textSecondary bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <span className="i-ph:lightbulb w-3.5 h-3.5 text-artify-elements-icon-success dark:text-artify-elements-icon-success" />
          ...
          <div>
            ...
            <select
              ...
              className={classNames(
                ...
                'bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-1',
                'border border-artify-elements-borderColor dark:border-artify-elements-borderColor',
                'text-artify-elements-textPrimary dark:text-artify-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-artify-elements-item-contentAccent dark:focus:ring-artify-elements-item-contentAccent',
                'disabled:opacity-50',
              )}
            >
              ...
              <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="flex items-center gap-2 hover:bg-artify-elements-item-backgroundActive/10 hover:text-artify-elements-textPrimary dark:hover:text-artify-elements-textPrimary transition-colors"
                  >
        ...
        {connection.user && connection.stats && (
          <div className="mt-6 border-t border-artify-elements-borderColor dark:border-artify-elements-borderColor pt-6">
            <div className="flex items-center gap-4 p-4 bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-1 rounded-lg mb-4">
              <img
                src={connection.user.avatar_url}
                alt={connection.user.login}
                className="w-12 h-12 rounded-full border-2 border-artify-elements-item-contentAccent dark:border-artify-elements-item-contentAccent"
              />
              <div>
                <h4 className="text-sm font-medium text-artify-elements-textPrimary dark:text-artify-elements-textPrimary">
                  {connection.user.name || connection.user.login}
                </h4>
                <p className="text-sm text-artify-elements-textSecondary dark:text-artify-elements-textSecondary">
            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between p-4 rounded-lg bg-artify-elements-background dark:bg-artify-elements-background-depth-2 border border-artify-elements-borderColor dark:border-artify-elements-borderColor hover:border-artify-elements-borderColorActive/70 dark:hover:border-artify-elements-borderColorActive/70 transition-all duration-200">
                  <div className="flex items-center gap-2">
                    <div className="i-ph:chart-bar w-4 h-4 text-artify-elements-item-contentAccent" />
                    <span className="text-sm font-medium text-artify-elements-textPrimary">GitHub Stats</span>
                  </div>
                  <div
                    className={classNames(
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  {/* Languages Section */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-artify-elements-textPrimary mb-3">Top Languages</h4>
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(connection.stats.languages)
                        ...
                        .map(([language]) => (
                          <span
                            key={language}
                            className="px-3 py-1 text-xs rounded-full bg-artify-elements-sidebar-buttonBackgroundDefault text-artify-elements-sidebar-buttonText"
                          >
                            {language}
                          </span>
                        ))}
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex flex-col p-3 rounded-lg bg-artify-elements-background-depth-2 dark:bg-artify-elements-background-depth-2 border border-artify-elements-borderColor dark:border-artify-elements-borderColor"
                      >
                        <span className="text-xs text-artify-elements-textSecondary">{stat.label}</span>
                        <span className="text-lg font-medium text-artify-elements-textPrimary">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-4">
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-sm font-medium text-artify-elements-textPrimary mb-2">Repository Stats</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-artify-elements-textPrimary mb-2">Contribution Stats</h5>
                          ...
                          {[
                            {
                              ...
                              icon: 'i-ph:star',
                              iconColor: 'text-artify-elements-icon-warning',
                            },
                            {
                              label: 'Forks',
                              value: connection.stats.forks || 0,
                              icon: 'i-ph:git-fork',
                              iconColor: 'text-artify-elements-icon-info',
                            },
                            {
                              label: 'Followers',
                              value: connection.stats.followers || 0,
                              icon: 'i-ph:users',
                              iconColor: 'text-artify-elements-icon-success',
                            },
                          ].map((stat, index) => (
                            <div
                              key={index}
                            ...
                            >
                              <span className="text-xs text-artify-elements-textSecondary">{stat.label}</span>
                              <span className="text-lg font-medium text-artify-elements-textPrimary flex items-center gap-1">
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-artify-elements-textPrimary mb-2">Gists</h5>
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            {
                              label: 'Public',
                      ...
                      <div className="pt-2 border-t border-artify-elements-borderColor">
                        <span className="text-xs text-artify-elements-textSecondary">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-artify-elements-textPrimary">Recent Repositories</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {connection.stats.repos.map((repo) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block p-4 rounded-lg bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-1 border border-artify-elements-borderColor dark:border-artify-elements-borderColor hover:border-artify-elements-borderColorActive dark:hover:border-artify-elements-borderColorActive transition-all duration-200"
                        >
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                <div className="i-ph:git-branch w-4 h-4 text-artify-elements-icon-tertiary" />
                                <h5 className="text-sm font-medium text-artify-elements-textPrimary group-hover:text-artify-elements-item-contentAccent transition-colors">
                                  {repo.name}
                                </h5>
                              </div>
                              <div className="flex items-center gap-3 text-xs text-artify-elements-textSecondary">
                                <span className="flex items-center gap-1" title="Stars">
                                  <div className="i-ph:star w-3.5 h-3.5 text-artify-elements-icon-warning" />
                                  {repo.stargazers_count.toLocaleString()}
                                </span>
                                <span className="flex items-center gap-1" title="Forks">
                                  <div className="i-ph:git-fork w-3.5 h-3.5 text-artify-elements-icon-info" />
                            ...
                            {repo.description && (
                              <p className="text-xs text-artify-elements-textSecondary line-clamp-2">
                                {repo.description}
                              </p>
                            )}
                            ...
                            <div className="flex items-center gap-3 text-xs text-artify-elements-textSecondary">
                              ...
                              <span className="flex items-center gap-1 ml-auto group-hover:text-artify-elements-item-contentAccent transition-colors">
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-artify-elements-textSecondary">Loading...</span>
      </div>
    </div>
  );
}
