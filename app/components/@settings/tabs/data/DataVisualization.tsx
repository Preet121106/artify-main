...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const getChartColors = (index: number) => {
    // Define color palettes based on artify design tokens
    const baseColors = [
      // Indigo
      {
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="i-ph-chart-line-duotone w-12 h-12 mx-auto mb-4 text-artify-elements-textTertiary opacity-80" />
        <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-2">No Data Available</h3>
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-4">Total Chats</h3>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-4">Total Messages</h3>
          <div className={statClasses}>
            <div className="i-ph-chat-text-duotone w-8 h-8 text-blue-500 dark:text-blue-400" />
            <span>{Object.values(messagesByRole).reduce((sum, count) => sum + count, 0)}</span>
          </div>
        </div>

        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-4">Avg. Messages/Chat</h3>
          <div className={statClasses}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-6">Chat History</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-6">Message Distribution</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary mb-6">API Usage by Provider</h3>
          <div className="h-64">
