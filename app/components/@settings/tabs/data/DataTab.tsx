...
export function DataTab() {
  // Use our custom hook for the artifyHistory database
  const { db, isLoading: dbLoading } = useartifyHistoryDB();
  ...
  // Data operations hook with artifyHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the artifyHistory database, converting null to undefined
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Chats Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-artify-elements-textPrimary">Chats</h2>
        {dbLoading ? (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  ...
                  <CardTitle className="text-lg group-hover:text-artify-elements-item-contentAccent transition-colors">
                    Export All Chats
                  </CardTitle>
                </div>
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-artify-elements-textPrimary">Settings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-artify-elements-textPrimary">API Keys</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-artify-elements-textPrimary">Data Usage</h2>
        <Card>
