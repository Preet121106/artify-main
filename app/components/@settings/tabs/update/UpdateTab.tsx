  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        <div>
          <h3 className="text-lg font-medium text-artify-elements-textPrimary">Updates</h3>
          <p className="text-sm text-artify-elements-textSecondary">Check for and manage application updates</p>
        </div>
      </motion.div>

      {/* Update Settings Card */}
      <motion.div
        className="p-6 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-lg font-medium text-artify-elements-textPrimary">Update Settings</h3>
        </div>

        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm text-artify-elements-textPrimary">Automatic Updates</span>
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm text-artify-elements-textPrimary">Check Interval</span>
              <p className="text-xs text-artify-elements-textSecondary">How often to check for updates</p>
            </div>
            <select
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-medium text-artify-elements-textPrimary">Update Status</h3>
          </div>
        ...
        {updateProgress?.details?.currentCommit && updateProgress?.details?.remoteCommit && (
          <div className="mt-4 text-sm text-artify-elements-textSecondary">
            <div className="flex items-center justify-between">
              <div>
                <p>
          ...
          <DialogDescription>
            <div className="mt-4">
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-[#F5F5F5] dark:bg-[#1A1A1A] rounded-lg p-3 space-y-2">
                    {updateProgress.details.commitMessages.map((msg, index) => (
                      <div key={index} className="text-sm text-artify-elements-textSecondary flex items-start gap-2">
              ...
              {updateProgress?.details?.totalSize && (
                <div className="flex items-center gap-4 text-sm text-artify-elements-textSecondary">
                  <div className="flex items-center gap-2">
