    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="i-ph:package text-artify-elements-textSecondary w-4 h-4" />
          <span className="text-base text-artify-elements-textPrimary">
          ...
          <div className="space-y-2 p-4">
            {deps.map((dep) => (
              <div key={dep.name} className="flex items-center justify-between text-sm">
                <span className="text-artify-elements-textPrimary">{dep.name}</span>
                <span className="text-artify-elements-textSecondary">{dep.version}</span>
              </div>
            ))}
          </div>
        </ScrollArea>
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Errors Card */}
        <div className="p-4 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-green-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:warning-octagon text-green-500 w-4 h-4" />
            <div className="text-sm text-artify-elements-textSecondary">Errors</div>
          </div>
        ...
        <div className="p-4 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-green-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:cpu text-green-500 w-4 h-4" />
            <div className="text-sm text-artify-elements-textSecondary">Memory Usage</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-green-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:timer text-green-500 w-4 h-4" />
            <div className="text-sm text-artify-elements-textSecondary">Page Load Time</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-green-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:wifi-high text-green-500 w-4 h-4" />
            <div className="text-sm text-artify-elements-textSecondary">Network Speed</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="md:col-span-4 p-6 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-green-500/30 transition-all duration-200 h-[260px] flex flex-col">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="i-ph:robot text-green-500 w-5 h-5" />
              <div>
                <div className="text-base font-medium text-artify-elements-textPrimary">Ollama Service</div>
                <div className="text-xs text-artify-elements-textSecondary mt-0.5">{status.message}</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="text-[10px] text-artify-elements-textTertiary flex items-center gap-1.5">
            ...
            {status.status === "Running" && ollamaStatus.models && ollamaStatus.models.length > 0 ? (
              <>
                <div className="text-xs font-medium text-artify-elements-textSecondary flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <div className="i-ph:cube-duotone w-4 h-4 text-green-500" />
                ...
                <div className="overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 dark:hover:scrollbar-thumb-gray-600">
                  <div className="grid grid-cols-2 gap-3 pr-2">
                    {ollamaStatus.models.map((model) => (
                      <div
                        key={model.name}
                        className="text-sm bg-artify-elements-background-depth-3 hover:bg-artify-elements-background-depth-4 rounded-lg px-4 py-3 flex items-center justify-between transition-colors group"
                      >
                        <div className="flex items-center gap-2 text-artify-elements-textSecondary">
                          <div className="i-ph:cube w-4 h-4 text-green-500/70 group-hover:text-green-500 transition-colors" />
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:cpu text-green-500 w-5 h-5" />
              <h3 className="text-base font-medium text-artify-elements-textPrimary">System Information</h3>
            </div>
            <div
              className={classNames(
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {systemInfo ? (
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:desktop text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">OS: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.os}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:device-mobile text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Platform: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.platform}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:circuitry text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Architecture: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.arch}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:cpu text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">CPU Cores: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.cpus}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:graph text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Node Version: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.node}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:wifi-high text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Network Type: </span>
                    <span className="text-artify-elements-textPrimary">
                      {systemInfo.network.type} ({systemInfo.network.effectiveType})
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:gauge text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Network Speed: </span>
                    <span className="text-artify-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:database text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Memory Usage: </span>
                    <span className="text-artify-elements-textPrimary">
                      {systemInfo.memory.used} / {systemInfo.memory.total} ({systemInfo.memory.percentage}%)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:browser text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Browser: </span>
                    <span className="text-artify-elements-textPrimary">
                      {systemInfo.browser.name} {systemInfo.browser.version}
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:monitor text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Screen: </span>
                    <span className="text-artify-elements-textPrimary">
                      {systemInfo.screen.width}x{systemInfo.screen.height} ({systemInfo.screen.pixelRatio}x)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:clock text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Timezone: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.time.timezone}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:translate text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Language: </span>
                    <span className="text-artify-elements-textPrimary">{systemInfo.browser.language}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:timer text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">Page Load: </span>
                    <span className="text-artify-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:code text-artify-elements-textSecondary w-4 h-4" />
                    <span className="text-artify-elements-textSecondary">DOM Ready: </span>
                    <span className="text-artify-elements-textPrimary">
              ...
              <div className="text-sm text-artify-elements-textSecondary">Loading system information...</div>
            )}
          </div>
        </CollapsibleContent>
      </Collapsible>
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:chart-line text-green-500 w-5 h-5" />
              <h3 className="text-base font-medium text-artify-elements-textPrimary">Performance Metrics</h3>
            </div>
            <div
              className={classNames(
                "i-ph:caret-down w-4 h-4 transform transition-transform duration-200",
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-artify-elements-textSecondary">Page Load Time: </span>
                    <span className="text-artify-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-artify-elements-textSecondary">DOM Ready Time: </span>
                    <span className="text-artify-elements-textPrimary">
                      {(systemInfo.performance.timing.domReadyTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-artify-elements-textSecondary">Request Time: </span>
                    <span className="text-artify-elements-textPrimary">
                      {(systemInfo.performance.timing.requestTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-artify-elements-textSecondary">Redirect Time: </span>
                    <span className="text-artify-elements-textPrimary">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm">
                    <span className="text-artify-elements-textSecondary">Heap Utilization: </span>
                    <span className="text-artify-elements-textPrimary">
                      {systemInfo.performance.memory.usagePercentage.toFixed(1)}%
                    </span>
                  </div>
                  ...
                  <div className="text-sm">
                    <span className="text-artify-elements-textSecondary">Redirects: </span>
                    <span className="text-artify-elements-textPrimary">
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-artify-elements-textPrimary">WebApp Information</h3>
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {loading.webAppInfo ? (
              ...
              <div className="flex flex-col items-center justify-center p-8 text-artify-elements-textSecondary">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h3 className="mb-4 text-base font-medium text-artify-elements-textPrimary">Basic Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:app-window text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Name:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.name}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:tag text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Version:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.version}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:certificate text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">License:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.license}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:cloud text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Environment:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.environment}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:graph text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Node Version:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.runtimeInfo.nodeVersion}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="mb-4 text-base font-medium text-artify-elements-textPrimary">Git Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-branch text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Branch:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.gitInfo.local.branch}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-commit text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Commit:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.gitInfo.local.commitHash}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:user text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Author:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.gitInfo.local.author}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:clock text-artify-elements-textSecondary w-4 h-4" />
                      <span className="text-artify-elements-textSecondary">Commit Time:</span>
                      <span className="text-artify-elements-textPrimary">{webAppInfo.gitInfo.local.commitTime}</span>
                    </div>
                    ...
                    {webAppInfo.gitInfo.github && (
                      <>
                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                          <div className="text-sm flex items-center gap-2">
                            <div className="i-ph:git-fork text-artify-elements-textSecondary w-4 h-4" />
                          ...
                          <div className="mt-2 flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-artify-elements-textSecondary">
                        ...
                        {webAppInfo.gitInfo.github.upstream && (
                          <div className="mt-2">
                            <div className="text-sm flex items-center gap-2">
                              <div className="i-ph:git-fork text-artify-elements-textSecondary w-4 h-4" />
                              <span className="text-artify-elements-textSecondary">Upstream:</span>
                              <span className="text-artify-elements-textPrimary">
            ...
            {webAppInfo && (
              <div className="mt-6">
                <h3 className="mb-4 text-base font-medium text-artify-elements-textPrimary">Dependencies</h3>
                <div className="bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] rounded-lg divide-y divide-[#E5E5E5] dark:divide-[#1A1A1A]">
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-artify-elements-textPrimary">Error Check</h3>
              {errorLogs.length > 0 && (
          ...
          <div className="p-6 mt-2 rounded-xl bg-gray dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <ScrollArea className="h-[300px]">
              <div className="space-y-4">
                <div className="text-sm text-artify-elements-textSecondary">
                  Checks for:
                ...
                {errorLogs.length > 0 && (
                  <div className="mt-4">
                    <div className="text-sm font-medium text-artify-elements-textPrimary mb-2">Recent Errors:</div>
                    <div className="space-y-2">
                      {errorLogs.map((error) => (
