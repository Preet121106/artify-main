  ...
  ({
    ...
    >
      <div className="p-4">
        ...
        <p className="mt-2 text-sm text-artify-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-artify-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
