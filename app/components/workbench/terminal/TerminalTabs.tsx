  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-artify-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-artify-elements-background-depth-2 border-y border-artify-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-artify-elements-textTertiary hover:text-artify-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting artify terminal [${index}]`);
            ...
            if (index == 0) {
              return (
                <Terminal
                  ...
                  onTerminalReady={(terminal) => workbenchStore.attachartifyTerminal(terminal)}
