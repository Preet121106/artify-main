...
function ContextMenuItem({ onSelect, children }: { onSelect?: () => void; children: ReactNode }) {
  return (
    <ContextMenu.Item
      onSelect={onSelect}
      className="flex items-center gap-2 px-2 py-1.5 outline-0 text-sm text-artify-elements-textPrimary cursor-pointer ws-nowrap text-artify-elements-item-contentDefault hover:text-artify-elements-item-contentActive hover:bg-artify-elements-item-backgroundActive rounded-md"
    >
...
function InlineInput({ depth, placeholder, initialValue = "", onSubmit, onCancel }: InlineInputProps) {
  ...
  return (
    <div
      className="flex items-center w-full px-2 bg-artify-elements-background-depth-4 border border-artify-elements-item-contentAccent py-0.5 text-artify-elements-textPrimary"
      style={{ paddingLeft: `${6 + depth * NODE_PADDING_LEFT}px` }}
    >
      <div className="scale-120 shrink-0 i-ph:file-plus text-artify-elements-textTertiary" />
      <input
        ref={inputRef}
        type="text"
        className="ml-2 flex-1 bg-transparent border-none outline-none py-0.5 text-sm text-artify-elements-textPrimary placeholder:text-artify-elements-textTertiary min-w-0"
    ...
    <>
      <ContextMenu.Root>
        ...
        <ContextMenu.Portal>
          <ContextMenu.Content
            style={{ zIndex: 998 }}
            className="border border-artify-elements-borderColor rounded-md z-context-menu bg-artify-elements-background-depth-1 dark:bg-artify-elements-background-depth-2 data-[state=open]:animate-in animate-duration-100 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-98 w-56"
          >
            <ContextMenu.Group className="p-1 border-b-px border-solid border-artify-elements-borderColor">
            ...
            <ContextMenu.Group className="p-1 border-t-px border-solid border-artify-elements-borderColor">
              {!isFolder ? (
                <>
